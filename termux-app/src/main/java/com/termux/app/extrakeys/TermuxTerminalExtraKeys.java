...
import com.termux.app.ui.GeminiApiBottomSheetFragment; // Uncommented and assuming this is the correct path
...
public final class TermuxTerminalExtraKeys {
    ...
    public void loadExtraKeysFromProperties() {
        try {
            ...
            try {
                ...
                throw new RuntimeException("Failed to load default extra keys: " + e2.getMessage());
            }
        }
    }
    ...
    public void onTerminalExtraKeyButtonClick(View view, String key, boolean ctrlDown, boolean altDown, boolean shiftDown, boolean fnDown) {
        ...
        } else if ("IA".equals(key)) {
            if (mActivity != null && mActivity.getSupportFragmentManager() != null) {
                GeminiApiBottomSheetFragment geminiSheet = new GeminiApiBottomSheetFragment();
                geminiSheet.show(mActivity.getSupportFragmentManager(), geminiSheet.getTag());
            } else {
                Log.e(TermuxConstants.LOG_TAG, "Cannot show Gemini BottomSheet: Activity or FragmentManager is null.");
                if (mActivity != null) {
                    mActivity.showTransientMessage("Error: Could not open AI Assistant panel.", true);
                }
            }
        } else {
